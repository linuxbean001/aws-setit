 ...
 if(this.state.homeBox) {
    ...
    handleSubmit = (event) => {
        ...
        if ((event.currentTarget.dataset.id == '1') || (event.currentTarget.dataset.id == '000') || (this.state.Errorindicator.length === 0)) {
            ...
            if (this.state.setItAndLeaveItRetirement) { setItAndLeaveItRetirementValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png">  ' + this.state.setItAndLeaveItRetirement + ' </p>'; }
            if (this.state.medicare) { medicareValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.medicare + ' </p>'; }
            if (this.state.noInsurance) { noInsuranceValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.noInsurance + ' </p>'; }
            if (this.state.supplementalHealth) { supplementalHealthValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.supplementalHealth + ' </p>'; }
            if (this.state.longtermcare) { longtermcareValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.longtermcare + ' </p>'; }
            if (this.state.aaii) { aaiiValue = '<p style="color:red;" className="answerContent"> <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> American Association of Individual Investors (AAII) </p>'; }
            if (this.state.advisorPerspectives) { advisorPerspectivesValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Advisor Perspectives </p>'; }
            if (this.state.alphaArchiect) { alphaArchiectValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Alpha Architect</p>'; }
            if (this.state.referralContent) { referralContentValue = '<p style="color:red;" className="answerContent"> <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Referral1111</p>'; }
            if (this.state.otherOthersContent) { otherOthersContentValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Other</p>'; }
            if (this.state.riskAggressive) { riskAggressiveValue = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Aggressive (healthy appetite for risk) </p>'; }
            if (this.state.riskModerate) { riskModerateValue = '<p style="color:red;" className="answerContent"> <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png">  Moderate (seek more balanced risk) </p>'; }
            if (this.state.riskConservative) { riskConservativeValue = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Conservative (generally prefer less risk) </p>'; }
            if (this.state.portfolio1) { portfolio1Value = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Portfolio 1 (most conservative) </p>'; }
            if (this.state.portfolio2) { portfolio2Value = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Portfolio 2</p>'; }
            if (this.state.portfolio3) { portfolio3Value = '<p style="color:red;" className="answerContent"> <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Portfolio 3</p>'; }
            if (this.state.portfolio4) { portfolio4Value = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Portfolio 4</p>'; }
            if (this.state.portfolio5) { portfolio5Value = '<p style="color:red;" className="answerContent"> <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Portfolio 5 (most aggressive)</p>'; }
            if (this.state.analyticalInExperience) { analyticalInExperienceValue = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> I am/we are very analytical (regardless of investment experience) </p>'; }
            if (this.state.capitalPreservation) { capitalPreservationValue = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Capital preservation (lower returns are OK if volatility is low) </p>'; }
            if (this.state.investIncome) { investIncomeValue = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Income (income for retirement or other purposes is a top priority) </p>'; }
            if (this.state.investGrowth) { investGrowthValue = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Growth (willing to accept higher volatility for higher returns) </p>'; }
            if (this.state.investGrowthIncome) { investGrowthIncomeValue = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Growth + income (higher volatility acceptable if income is secure) </p>'; }
            if (this.state.investAggressiveGrowth) { investAggressiveGrowthValue = '<p style="color:red;" className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Aggressive growth (returns are top priority and significant volatility is acceptable)</p>'; }
            if (this.state.fixedAnnuityProduct) { fixedAnnuityProductValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.fixedAnnuityProduct + ' </p>'; }
            if (this.state.insuranceProduct) { insuranceProductValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.insuranceProduct + ' </p>'; }
            if (this.state.investmentAdvice) { investmentAdviceValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.investmentAdvice + ' </p>'; }
            if (this.state.estatePlanning) { estatePlanningValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.estatePlanning + ' </p>'; }
            if (this.state.otherGoalService) { otherGoalServiceValue = '<p style="color:red;" className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.otherGoalService + ' </p>'; }
            if (this.state.iWeRent) { iWeRentValue = '<p  className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> ' + this.state.iWeRent + ' </p>'; }
            if (this.state.homeBanking) { homeBankingValue = '<p  className="answerContent"><img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Banking </p>'; }
            if (this.state.homeBrokerage) { homeBrokerageValue = '<p  className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Brokerage (taxable)</p>'; }
            if (this.state.homeRetirementAccount) { homeRetirementAccountValue = '<p className="answerContent"> <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Retirement accounts</p>'; }
            if (this.state.homeRothAccount) { homeRothAccountValue = '<p  className="answerContent"> <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Roth accounts</p>'; }
            if (this.state.homeOther) { homeOtherValue = '<p className="answerContent"> <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Other</p>'; }
            if (this.state.AssetsApproxTotal) { AssetsApproxTotalValue = formatter.format(this.state.AssetsApproxTotal); } else {
              AssetsApproxTotalValue = '$0,000';
            }
            if (this.state.homeSS) { homeSSValue = '<pclassName="answerContent"> <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Social security</p>'; }
            if (this.state.homePension) { homePensionValue = '<p className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Pension(s)</p>'; }
  
            if (this.state.lifeInsurance) { lifeInsuranceValue = '<p className="answerContent">  <img width="14px" src="http://pluspng.com/img-png/tick-box-png-checked-checkbox-icon-png-50-px-1600.png"> Life insurance</p>'; }

            if (this.state.socailSecurity) {
                socailSecurityValue = parseInt(this.state.socailSecurity.replace(/,/g, ""));
              }
              if (this.state.pension) {
                pensionValue = parseInt(this.state.pension.replace(/,/g, ""));
              }
              if (this.state.monthlyRent) {
                monthlyRentValue = parseInt(this.state.monthlyRent.replace(/,/g, ""));
              }
              if (this.state.banking) {
                bankingValue = parseInt(this.state.banking.replace(/,/g, ""));
              }
              if (this.state.brokerage) {
                brokerageValue = parseInt(this.state.brokerage.replace(/,/g, ""));
              }
              if (this.state.retirementAccount) {
                retirementAccountValue = parseInt(this.state.retirementAccount.replace(/,/g, ""));
              }
              if (this.state.rothAccount) {
                rothAccountValue = parseInt(this.state.rothAccount.replace(/,/g, ""));
              }
              if (this.state.otherApproxValue) {
                otherApproxValue12 = parseInt(this.state.otherApproxValue.replace(/,/g, ""));
              }
              if (this.state.essential) {
                essentialValue = parseInt(this.state.essential.replace(/,/g, ""));
              }
              if (this.state.lifeamount) {
                lifeamountValue = parseInt(this.state.lifeamount);
              }
              if (this.state.referralContent) {
                referralContentValue = parseInt(this.state.referralContent);
              }
              if (this.state.otherOthersContent) {
                otherOthersContentValue = parseInt(this.state.otherOthersContent);
              }
              if (this.state.discretionary) {
                discretionaryValue = parseInt(this.state.discretionary.replace(/,/g, ""));
              }
              if (this.state.homeValue) {
                homeValuedata = parseInt(this.state.homeValue.replace(/,/g, ""))
              }
              if (this.state.Mortgage) {
                MortgageValuedata = parseInt(this.state.Mortgage.replace(/,/g, ""))
              } else {
                MortgageValuedata = 0;
              }


            let pdfHtml = '<div className="testHello"><div><div className="col-lg-12 col-md-12 col-sm-12"><div className="dashboard-contents questionAdminBorad" id="profileDashboardprint"><div class="row"><h4 style="text-align:center;">CONTACT DETAILS</h4><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="name">Name</label><p style="color:red;" className="answerContent">' + this.state.name + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="address"> Address:</label><p style="color:red;"  className="answerContent">' + this.state.address + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="phone">Phone</label><p style="color:red;"  className="answerContent">' + this.state.phone + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="reasonGoalConsultation"> Best time(s) to schedule free consultation</label><p style="color:red;"  className="answerContent">' + this.state.reasonGoalConsultation + '</p></div></div></div></div></div><div ><div style="page-break-before:always"></div><div className="col-lg-12 col-md-12 col-sm-12"><div className="dashboard-contents questionAdminBorad" id="profileDashboardprint"><div class="row"><h4 style="text-align:center;">GOALS DETAILS</h4><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">Services you may be interested in </label>' + setItAndLeaveItRetirementValue + fixedAnnuityProductValue + insuranceProductValue + investmentAdviceValue + estatePlanningValue + otherGoalServiceValue + '<p style="color:red;" className="answerContent">' + this.state.otherGoalService + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="address"> Comments regarding your goals for this consultation:</label><p style="color:red;" className="answerContent">' + this.state.goalComment + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="phone">Specific questions/topics you would like to address</label><p style="color:red;" className="answerContent">' + this.state.goalQuestion + '</p></div></div></div></div></div></div> <div style="page-break-before:always"></div><div className="col-lg-12 col-md-12 col-sm-12"><div className="dashboard-contents questionAdminBorad" id="profileDashboardprint"><div class="row"><h4 style="text-align:center;">PERSONAL DETAILS</h4><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" >Age</label><p style="color:red;" className="answerContent">' + this.state.age + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="address"> Married</label><p style="color:red;" className="answerContent">' + this.state.married + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="phone">Kids</label><p style="color:red;" className="answerContent">' + this.state.Kids + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="phone">Grand Kids</label><p style="color:red;" className="answerContent">' + this.state.grandkid + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="phone">Pets</label><p style="color:red;" className="answerContent">' + this.state.pets + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="phone">Other relevant details</label><p style="color:red;" className="answerContent">' + this.state.personalOtherDetails + '</p></div></div></div></div><div style="page-break-before:always"></div><div className="col-lg-12 col-md-12 col-sm-12"><div className="dashboard-contents questionAdminBorad" id="profileDashboardprint"><div class="row"><h4 style="text-align:center;">ASSETS DETAILS</h4><div style="width:100%" className="col-md-12 col-sm-12"><h6 style="font-weight:600;color:#000;font-size:18px;">Types of assets:</h6><table style="width:100%"><tr><td style="font-weight:600;color:#000;">Home value</td><td style="font-weight:600;color:#000;">Mortgage</td><td style="font-weight:600;color:#000;">Approx. equity</td></tr><tr><td style="color:red;">' + formatter.format(homeValuedata) + '</td><td style="color:red;">' + formatter.format(MortgageValuedata) + '</td><td style="color:red;">' + formatter.format(AssetsApproxEquity) + '</td></tr></table></div><span className="bline"></span><div style="width:100%" className="col-md-12 col-sm-12"><table style="width:100%;margin-top:20px"><tr style="width:100%"><td></td><td style="font-weight:600;color:#000;" >Monthly rent</td></tr><tr style="width:100%"><td> ' + iWeRentValue + '</td><td style="color:red">' + formatter.format(monthlyRentValue) + '</td></tr></table></div><span className="bline"></span><div className="col-md-12 col-sm-12"><table style="width:100%;margin-top:20px;"><tr style="width:100%"><th></th><th>Estimated value in accounts</th></tr><tr style="width:100%"><td>' + homeBankingValue + '</td><td style="color:red;">' + formatter.format(bankingValue) + '</td></tr><tr style="width:100%"><td>' + homeBrokerageValue + '</td><td style="color:red;">' + formatter.format(brokerageValue) + '</td></tr><tr style="width:100%"><td>' + homeRetirementAccountValue + '</td><td style="color:red;">' + formatter.format(retirementAccountValue) + '</td></tr><tr style="width:100%"><td>' + homeRothAccountValue + '</td><td style="color:red;">' + formatter.format(rothAccountValue) + '</td></tr><tr style="width:100%"><td>' + homeOtherValue + '</td><td style="color:red;">' + this.state.otherTypes + ' &nbsp;&nbsp;&nbsp;&nbsp; ' + formatter.format(otherApproxValue12) + '</td></tr><tr><td>Approx. asset total</td><td style="color:red;"> ' + formatter.format(AssetsApproxTotal) + '</td></tr></table></div><span className="bline"></span><div className="col-md-12 col-sm-12"><h6 style="font-weight:600;color:#000;font-size:18px;">Income:</h6><table style="width:100%;margin-bottom:20px;"><tr style="width:100%"><th></th><th>Total annual income</th></tr><tr style="width:100%"><td>' + homeSSValue + '</td><td style="color:red;">' + formatter.format(socailSecurityValue) + '</td></tr><tr style="width:100%"><td>' + homePensionValue + '</td><td style="color:red;"> ' + formatter.format(pensionValue) + '</td></tr></table></div><div style="width:100%" className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" >Other</label><p style="color:red;" className="answerContent">' + this.state.others + '</p></div></div></div></div><div style="page-break-before:always"></div><div className="testHello"><div><div className="col-lg-12 col-md-12 col-sm-12"><div className="dashboard-contents questionAdminBorad" id="profileDashboardprint"><div class="row"><h4 style="text-align:center;">BUDGET DETAILS (ANNUAL SPENDNG)</h4><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="essential">Essential spending (bare minimum spending requirement)</label> <p style="color:red;" className="answerContent"></p><p style="color:red;">' + formatter.format(essentialValue) + '</td></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="discretionary">Discretionary</label><p style="color:red;" className="answerContent"></p><p style="color:red;">' + formatter.format(discretionaryValue) + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="discretionary">Approx. total: </label><p style="color:red;" className="answerContent"></p><p style="color:red;">' + formatter.format(AssetsApproxBudget) + '</p></div><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="oneOffExpenses">Expected trend for expenses & one-off expenses<p style="color:red;" className="answerContent">' + this.state.oneOffExpenses + '</p></div></div></div></div></div><div><div style="page-break-before:always"></div><div className="col-lg-12 col-md-12 col-sm-12"><div className="dashboard-contents questionAdminBorad" id="profileDashboardprint"><div class="row"><h4 style="text-align:center;">INSURANCE DETAILS</h4><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;"></label>' + medicareValue + noInsuranceValue + supplementalHealthValue + longtermcareValue + '<label style="font-weight:600;color:#000;"></label></div><span className="bline"></span><div className="col-md-12 col-sm-12"><table style="width:100%"><tr><td style="font-weight:600;color:#000;"></td><td style="font-weight:600;color:#000;">Type</td><td style="font-weight:600;color:#000;">Amount</td></tr><tr><td style="color:red;">' + lifeInsuranceValue + '</td> <td style="color:red;">' + this.state.lifeInType + '</td><td style="color:red;">' + formatter.format(lifeamountValue) + '</td></tr></table></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="inother">Other</label><p style="color:red;" className="answerContent">' + this.state.inother + '</p></div></div></div></div><div style="page-break-before:always"></div><div className="col-lg-12 col-md-12 col-sm-12"><div className="dashboard-contents questionAdminBorad" id="profileDashboardprint"><div class="row"><h4 style="text-align:center;">INVESTING DETAILS</h4><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="experience_1_10">Investment experience (1= novice / 10 = expert)</label><p style="color:red;" className="answerContent">' + this.state.experience_1_10 + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;"></label>' + analyticalInExperienceValue + '<label style="font-weight:600;color:#000;"></label>' + '</div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">Performance expectations</label><p style="color:red;" className="answerContent">' + this.state.expectations + '</p></div><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">Notable investment experiences (good and/or bad)</label><p style="color:red;" className="answerContent">' + this.state.experience_gb + '</p></div><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">Investment performance goals (tick all that apply)</label>' + capitalPreservationValue + investIncomeValue + investGrowthValue + investGrowthIncomeValue + investAggressiveGrowthValue + '<label style="font-weight:600;color:#000;"></label>' + '</div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="currentAllocationStock">Current allocation to stocks and other risky assets</label><p style="color:red;" className="answerContent">' + this.state.currentAllocationStock + '</p></div><span className="bline"></span></div></div></div><div style="page-break-before:always"></div><div className="col-lg-12 col-md-12 col-sm-12"><div className="dashboard-contents questionAdminBorad" id="profileDashboardprint"><div class="row"><h4 style="text-align:center;">RISK DETAILS</h4><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">How do you view your risk tolerance?</label>' + riskAggressiveValue + riskModerateValue + riskConservativeValue + '<label style="font-weight:600;color:#000;"></label>' + '</div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;" htmlFor="portfolioDrawdown">Assuming your financial security would not be compromised, what is the maximum portfolio drawdown (decrease) you could tolerate?</label><p style="color:red;" className="answerContent">' + this.state.portfolioDrawdown + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">Please score the importance of each factor:</label><br/> <label style="font-weight:600;color:#000;" htmlFor="riskPreservation">Preservation</label><p style="color:red;" className="answerContent">' + this.state.riskPreservation + '</p><label style="font-weight:600;color:#000;" htmlFor="riskIncome"> Income</label><p style="color:red;" className="answerContent">' + this.state.riskIncome + '</p><label style="font-weight:600;color:#000;" htmlFor="riskGrowth"> Growth</label><p style="color:red;" className="answerContent">' + this.state.riskGrowth + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">How did you and your portfolio hold up during the last major market downturn (e.g., the credit crisis in 2008)?</label><p style="color:red;" className="answerContent">' + this.state.lastMarketDownturn + '</p></div><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">Please look at the example portfolios below and select the one with the most appealing risk-return profile over this hypothetical 10-year period.</label>' + portfolio1Value + portfolio2Value + portfolio3Value + portfolio4Value + portfolio5Value + '<label style="font-weight:600;color:#000;"></label>' + '<img width="400px" src="https://firebasestorage.googleapis.com/v0/b/test-85de8.appspot.com/o/portfolio.png?alt=media&token=d318a273-2936-45ed-a057-ac9644371161"/></div><span className="bline"></span></div></div></div><div style="page-break-before:always"></div><div className="col-lg-12 col-md-12 col-sm-12"><div className="dashboard-contents questionAdminBorad" id="profileDashboardprint"><div class="row"><h4 style="text-align:center;">OTHER DETAILS</h4><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">How did you discover SET IT AND LEAVE IT?</label>' + aaiiValue + advisorPerspectivesValue + alphaArchiectValue + '<label style="font-weight:600;color:#000;"></label>' + '</div><span className="bline"></span><div style="width:100%" className="col-md-12 col-sm-12"><table style="width:100%;margin-top:20px"><tr style="width:100%"><td></td><td style="font-weight:600;color:#000;">Referral22222222</td></tr><tr style="width:100%"><td> ' + (referralContentValue) + '</td><td>' + formatter.format(referralContentValue) + '</td></tr></table></div><span className="bline"></span><div style="width:100%" className="col-md-12 col-sm-12"><table style="width:100%;margin-top:20px"><tr style="width:100%"><td></td><td style="font-weight:600;color:#000;"> Other</td></tr><tr style="width:100%"><td> ' + otherOthersContentValue + '</td><td>' + formatter.format(otherOthersContentValue) + '</td></tr></table></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">What attracted you to SET IT AND LEAVE IT?</label><p style="color:red;" className="answerContent">' + this.state.whatAttracted + '</p></div><span className="bline"></span><div className="col-md-12 col-sm-12"><label style="font-weight:600;color:#000;">We welcome suggestions to help us improve this questionnaire:</label><p style="color:red;" className="answerContent">' + this.state.improveQuestionnaire + '</p></div><span className="bline"></span></div></div></div>'

            questionInfoVo.pdfHtml1 = pdfHtml
